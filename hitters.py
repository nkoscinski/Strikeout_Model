...
pitch_counts = ["0_0", "0_1", "0_2", "1_0", "2_0", "3_0", "1_1", "1_2", "2_1", "2_2", "3_1", "3_2"]
...
for pitch_count in pitch_counts:
    ...
    pairs = [
        ...
        for batter_key in keys if batter_key.startswith("batter")
        for pitcher_key in keys if pitcher_key.startswith("pitcher")
    ]
    ...
    for batter_df, pitcher_df in pairs:
        ...
        result_df = batter_df[columns_to_convert].multiply(pitcher_df[columns_to_convert])
...
# Print all resulting dataframes
